    ...
    internal static class ViewComponents
    {
            ...
            string preWrittenText = null)
        {
            ...
            do
            {
                ...
                if(preWrittenText != null)
                {
                    Console.Write(preWrittenText);
                }
                input = preWrittenText + Console.ReadLine(); // Get user input
                ...
                if(regexValidator != null && Regex.Match(input, regexValidator).Success == false)
                {
                    Console.WriteLine("Input is not valid, press any key to try again.");
                    Console.ReadKey();
                    valid = false;
                }
